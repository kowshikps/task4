...
function getData(tableId){
    ...
    tableElement.dataTable( {
		"bDestroy": true,
		"sDom": "<'row bg-blue-light no-margin p-t-5'<'col-md-6'l><'col-md-6'f>r>t<'row'<'col-md-12'p i>>",
			"oTableTools": {
			"aButtons": [
				{
					"sExtends":    "collection",
	...
	$('#'+tableId+' th').click(function(e) { 
			$('#'+tableId+' .animate-progress-bar').each(function () {
	...
	$('#'+tableId+'_wrapper .dataTables_filter input').addClass("input-medium "); // modify table search input
    $('#'+tableId+'_wrapper .dataTables_length select').addClass("select2-wrapper span12"); // modify table per page dropdown
