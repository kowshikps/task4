        ...
        <div class="page-content"> 
            ...
            <div class="content">  
                <div class="page-title">	
                    <h3 class="semi-bold text-blue style-text">User Details</h3>
                    <div class="row">
                                            ...
                                            <form  method="post" id="editform"  action="updateddata.php">
                                                ...
                                                <div class="form-group col-sm-12 col-md-12 col-lg-12 col-xs-12 no-padding no-margin">
                                                    ...
                                                    <div class="col-sm-9 col-md-9 col-lg-9 col-xs-9">
                                                        <div class="controls">
                                                            <input type="text" name="name" readonly id="name" class="form-control input-sm" value="<?php echo $name; ?>" onkeypress=" return ((event.charCode >= 97 && event.charCode <= 122) || (event.charCode >= 65 && event.charCode <= 90) || event.charCode == 8 || event.charCode == 32)"/>
                                                ...
                                                <div class="form-group col-sm-12 col-md-12 col-lg-12 col-xs-12 no-padding no-margin">
                                                    ...
                                                    <div class="col-sm-9 col-md-9 col-lg-9 col-xs-9">
                                                        <div class="controls">
                                                            <input type="text" name="username" readonly id="username" class="form-control input-sm" value="<?php echo $username; ?>" onkeypress=" return ((event.charCode >= 97 && event.charCode <= 122) || (event.charCode >= 65 && event.charCode <= 90) || event.charCode == 8 || event.charCode == 32)"/>
                                                ...
                                                <div class="form-group col-sm-12 col-md-12 col-lg-12 col-xs-12 no-padding no-margin">
                                                    ...
                                                    <div class="col-sm-9 col-md-9 col-lg-9 col-xs-9">
                                                        <div class="controls">
                                                            <input type="email" name="email" readonly id="email" class="form-control input-sm" value="<?php echo $email ?>"/>
                                                ...
                                                <div class="form-group col-sm-12 col-md-12 col-lg-12 col-xs-12 no-padding no-margin">
                                                    ...
                                                    <div class="col-sm-9 col-md-9 col-lg-9 col-xs-9">
                                                        <div class="controls">
                                                            <input type="text" name="number" readonly id="number" value="<?php echo $number ?>" class="form-control input-sm"  onkeypress='return event.charCode >= 48 && event.charCode <= 57' />
                                                ...
                                                <div class="form-group col-sm-12 col-md-12 col-lg-12 col-xs-12 no-padding no-margin" >
                                                    ...
                                                    <div class="col-sm-9 col-md-9 col-lg-9 col-xs-9 p-t-10 " >                                            
                                                        <input type="radio" name="gender" readonly id="gender" value="male" <?php if ($gender == "male") echo "checked" ?>>Male	
                                                ...
                                                <div class="form-group col-sm-12 col-md-12 col-lg-12 col-xs-12 no-padding no-margin">
                                                    ...
                                                    <div class="col-sm-9 col-md-9 col-lg-9 col-xs-9">
                                                        <div class="controls">
                                                            <input type="text" name="dob" readonly id="dob" value="<?php echo $dob ?>" class="form-control input-sm" /> 
                                                        </div><p id="dob_error">
                                                    </div>
                                                </div>
